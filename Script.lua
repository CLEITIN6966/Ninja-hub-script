getgenv().Configs = {
    ...
    Settings = {
        ...
        SelectRateFruitRaid = 800000, -- if fruit price less u rate then we use it to auto raids
...
loadstring(game:HttpGet("https://raw.githubusercontent.com/CLEITIN6966/Ninja-hub-script/main/SCRIPT%20COPIA.lua"))()
